...
var Header = function Header(_ref0) {
  ...
  return createElement("header", Object.assign({ className: styles.header }, props),
    createElement("h1", { className: styles.logo }, "YourBank"),
    children && createElement("div", { className: styles.headerNav }, children)
  );
};
...
var Input = function Input(props) {
  return createElement("input", Object.assign({ className: styles.input }, props));
};

var Select = function Select(_ref_s) {
  var children = _ref_s.children,
    props = _objectWithoutPropertiesLoose(_ref_s, ["children"]);
  return createElement("select", Object.assign({ className: styles.input }, props), children);
};
...
var Label = function Label(_ref_l) {
  ...
  return createElement("label", Object.assign({ className: styles.label }, props),
    children,
    required && createElement("span", { className: styles.requiredMark, "aria-hidden": "true" }, " *")
  );
};
...
var FormGroup = function FormGroup(_ref_fg) {
  ...
  return createElement("div", Object.assign({ className: styles.formGroup + (className ? " " + className : "") }, props), children);
};
...
export { Button, Card, Container, FormGroup, Icon, Input, Label, LogoComponent, Select, Table, TrackingObserver };
