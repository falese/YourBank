...
var ThemeToggle = function ThemeToggle() {
  ...
  }, "Current Theme: ", theme, React.createElement("button", {
    onClick: toggleTheme
  }, "Toggle Theme"));
};
...
var Card = function Card(_ref4) {
  ...
  }, props), (headerIcon || headerTitle || underHeaderIcon) && React.createElement("div", {
    className: styles.cardHeader
  }, React.createElement("div", {
    className: styles.headerContent
  }, headerIcon, headerTitle && React.createElement("h2", {
    className: styles.cardTitle
  }, headerTitle)), underHeaderIcon && React.createElement("div", {
    className: styles.underHeaderIcon
  }, underHeaderIcon)), React.createElement("div", {
...
var GlobalContext = React.createContext(_extends({}, initialState, {
...
var GlobalProvider = function GlobalProvider(_ref7) {
  ...
  var _useReducer = React.useReducer(globalReducer, initialState),
    state = _useReducer[0],
